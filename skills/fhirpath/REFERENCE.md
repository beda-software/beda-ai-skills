...
| Questionnaire (backend-evaluated)  | `initialExpression`, `itemConstraint`                      | `%resource`, `%questionnaire` (preferred); `%QuestionnaireResponse`, `%Questionnaire` (legacy) | [fhir-emr-questionnaire](../fhir-emr-questionnaire/SKILL.md)       |
